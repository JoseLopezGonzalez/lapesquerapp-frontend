...
export const baseDomain = isPesquerApp
  ? 'lapesquerapp.es'
  : (process.env.NEXT_PUBLIC_APP_GENERIC_BASE_DOMAIN || '').trim() || '';
...
export const appleTouchIconPath = isPesquerApp
...
export const icon192Path = isPesquerApp
  ? '/pesquerapp/icons/icon-192x192.png'
  : '/icons/icon-192x192-generic.png';
export const icon512Path = isPesquerApp
  ? '/pesquerapp/icons/icon-512x512.png'
  : '/icons/icon-512x512-generic.png';
