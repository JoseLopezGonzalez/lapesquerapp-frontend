...
export default function WarehouseOperatorPage({ params }) {
          ...
          <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 sm:px-6 lg:px-8">
            <div className="w-full max-w-md space-y-8">
              ...
              <div className="mt-8 space-y-6">
                ...
                <Button onClick={handleRedirectToCorrectStore} size="lg" className="w-full gap-2">
  ...
  if (!storeData) {
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center">
          <h2 className="mb-4 text-2xl font-bold text-gray-900">Almacén no encontrado</h2>
          <p className="text-gray-600">No tienes acceso a este almacén o no existe.</p>
        </div>
      </div>
    );
  }
