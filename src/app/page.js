  ...
  return (
    <>
      ...
      <NextUIProvider>
            ...
            <form>
              <div class="mt-8 space-y-4">
                <div>
                  ...
                  <div class="relative">
                    <input type="text" id="hs-cover-with-gradient-form-name-1" class="py-3 ps-11 pe-4 block w-full bg-white/10 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder="Full name" />
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="email" id="hs-cover-with-gradient-form-email-1" class="py-3 ps-11 pe-4 block w-full bg-white/10 border-white/20 text-white placeholder:text-white rounded-lg text-sm focus:border-white/30 focus:ring-white/30 sm:p-4 sm:ps-11" placeholder="Email address"/>
                      <div class="absolute inset-y-0 start-0 flex items-center pointer-events-none z-20 ps-4">
                ...
                <div class="grid">
                  <button type="submit" class="sm:p-4 py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-white/10 text-white hover:bg-white/20 focus:outline-none focus:bg-white/20 disabled:opacity-50 disabled:pointer-events-none">
                    Join the waitlist
        ...
        <div class="absolute bottom-0 inset-x-0 text-center py-5">
          <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            <p class="text-sm text-white/50">© 2025 Preline Labs. A product of <a class="text-white font-medium hover:text-white/80 focus:outline-none focus:text-white/80" href="../index.html">Htmlstream</a></p>
          </div>
        </div>
      </NextUIProvider>
      {/*  </ProtectedRoute>  */}
