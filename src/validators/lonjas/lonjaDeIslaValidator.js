  ...
  if (document.tables.peces) {
    ...
    document.tables.peces.forEach((row, rowIndex) => {
      ...
      validator.requireField(
        row.descripcion,
        'descripcion',
        `document[${index}].tables.peces[${rowIndex}]`
      );
  ...
  if (document.tables.vendidurias) {
    ...
    document.tables.vendidurias.forEach((row, rowIndex) => {
      validator.requireField(
        row.vendiduria,
        'vendiduria',
        `document[${index}].tables.vendidurias[${rowIndex}]`
      );
      validator.requireField(
        row.cajas,
        'cajas',
  ...
  if (document.tables.cajas) {
    ...
    document.tables.cajas.forEach((row, rowIndex) => {
      validator.requireField(
        row.descripcion,
        'descripcion',
        `document[${index}].tables.cajas[${rowIndex}]`
      );
  ...
  if (document.tables.tipoVentas) {
    ...
    document.tables.tipoVentas.forEach((row, rowIndex) => {
      ...
      validator.requireField(
        row.descripcion,
        'descripcion',
        `document[${index}].tables.tipoVentas[${rowIndex}]`
      );
      validator.requireField(
        row.cajas,
        'cajas',
