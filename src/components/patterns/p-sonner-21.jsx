...
function LoadingToast({
  ...
  return (
    <div
      className="bg-popover text-popover-foreground border-border rounded-md flex w-[356px] items-center gap-3 border p-4 shadow-lg">
...
function SuccessToast() {
  return (
    <div
      className="bg-popover text-popover-foreground border-border rounded-md flex w-[356px] items-start gap-3 border p-4 shadow-lg">
      <div
