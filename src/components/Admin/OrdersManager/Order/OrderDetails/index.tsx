                      ...
                      <div className="grid grid-cols-2 gap-2">
                        <div className="flex h-[32px] w-full items-center overflow-hidden rounded border border-black bg-blue-700 shadow-md dark:border-white">
                          ...
                          <div
                            ...
                            className="flex h-full flex-1 items-center justify-center bg-white py-0.5 text-center text-base text-black lining-nums"
                          >
                            {order.truckPlate ? (
                              order.truckPlate
                            ) : (
                        ...
                        <div className="flex h-[32px] w-full items-center overflow-hidden rounded border-2 border-red-800 bg-red-600 shadow-md">
                          <div
                            style={{ fontFamily: 'OCR A Std, monospace', fontWeight: 600 }}
                            className="flex h-full flex-1 items-center justify-center py-0.5 text-center text-base text-white lining-nums"
                          >
                            {order.trailerPlate ? (
                              order.trailerPlate
                            ) : (
