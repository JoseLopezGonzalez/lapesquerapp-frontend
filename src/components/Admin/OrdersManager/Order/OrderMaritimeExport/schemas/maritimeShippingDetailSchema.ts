...
export const maritimeShippingDetailSchema = z.object({
  ...
  bookingNumber: z.string().max(100, 'Máximo 100 caracteres').nullable().optional(),
  originCountry: z.string().max(100, 'Máximo 100 caracteres').nullable().optional(),
  destinationCountry: z.string().max(100, 'Máximo 100 caracteres').nullable().optional(),
