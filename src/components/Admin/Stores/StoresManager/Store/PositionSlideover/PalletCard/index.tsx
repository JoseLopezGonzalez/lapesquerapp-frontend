...
export default function PalletCard({ pallet }: PalletCardProps) {
  ...
  return (
    <div className="isolate" style={{ perspective: '1000px' }}>
      <div
        style={{
      ...
      >
        {/* Grid stacks both faces in the same cell — container height = max(front, back) */}
        <div style={{ display: 'grid', transformStyle: 'preserve-3d' }}>
          ...
          >
            ...
            >
              <div className="flex min-w-0 flex-1 items-center gap-2.5">
                ...
                >
                  <Layers
                    className={cn('h-4 w-4', isRelevant ? 'text-white' : 'text-background')}
                  />
                </div>
          ...
          >
            {/* Back header */}
            <div
              className={cn('px-4 py-3', isRelevant ? 'bg-green-500 text-white' : 'bg-muted/40')}
            >
              <p
                className={cn(
