...
export const ProcessInfoForm = ({
    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="space-y-1.5">
        ...
        <div className="flex max-w-full min-w-0 items-center gap-2">
          {processTypeOptions.length > 0 ? (
            ...
            <div className="border-input bg-muted/40 text-muted-foreground flex h-9 w-full min-w-0 items-center rounded-lg border px-3 text-sm">
      ...
      {isEditMode ? (
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="finished_at" className="text-sm">
  ...
  return (
    <Card>
      ...
      <CardContent className="pt-0">{formInner}</CardContent>
    </Card>
  );
};
