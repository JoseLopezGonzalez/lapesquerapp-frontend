    ...
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>{editingItem ? 'Editar Coste' : 'Nuevo Coste en Catálogo'}</DialogTitle>
              <DialogDescription>
      ...
      <CardContent>
        ...
        <div className="mb-4 flex gap-4">
          ...
          <div className="flex items-center gap-2">
            <Checkbox
              ...
              onCheckedChange={(checked) => setFilter({ ...filter, active_only: checked })}
            />
        ...
        {loading && catalog.length === 0 ? (
          ...
          <div className="py-8 text-center text-gray-500">No hay costes en el catálogo</div>
        ) : (
          <Table>
            <TableHeader>
              <TableRow>
            ...
            <TableBody>
              {catalog.map((item) => (
                <TableRow key={item.id}>
                  ...
                  <TableCell>{item.defaultUnit === 'total' ? 'Total' : 'Por kg'}</TableCell>
                  <TableCell>
