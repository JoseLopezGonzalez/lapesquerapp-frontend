      ...
      <CardContent className="py-3">
        <div className="space-y-3">
          ...
          <div>
            <Link
              href={targetHref}
              className="focus:ring-ring block truncate rounded text-base font-medium hover:underline focus:ring-2 focus:ring-offset-2 focus:outline-none"
            >
              {item.label}
            </Link>
          </div>
          <div className="min-w-0">
            <p className="text-sm font-medium wrap-break-word whitespace-pre-wrap">
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent size="md">
        <DialogHeader>
          ...
          <DialogDescription>
            Cambia solo la fecha. Si no se envía nota, la nueva acción pendiente conservará
            automáticamente el detalle actual.
          </DialogDescription>
        </DialogHeader>
                ...
                {(crmData?.inactive_customers ?? []).length === 0 ? (
                  ...
                  <div className="max-w-full **:data-[slot=table-container]:max-h-[360px] **:data-[slot=table-container]:overflow-y-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="bg-card sticky top-0 z-10">Cliente</TableHead>
                          <TableHead className="bg-card sticky top-0 z-10">Estado</TableHead>
                ...
                {(crmData?.prospects_without_activity ?? []).length === 0 ? (
                  ...
                  <div className="max-w-full **:data-[slot=table-container]:max-h-[360px] **:data-[slot=table-container]:overflow-y-auto">
                    <Table>
                      <TableHeader>
                        <TableRow>
                          <TableHead className="bg-card sticky top-0 z-10">Prospecto</TableHead>
                          <TableHead className="bg-card sticky top-0 z-10">Estado</TableHead>
                          <TableHead className="bg-card sticky top-0 z-10 text-right">
                            Sin actividad
                          </TableHead>
