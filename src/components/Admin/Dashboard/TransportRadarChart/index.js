    ...
    <Card className="w-full max-w-full overflow-hidden">
      ...
      <CardContent className="flex flex-col items-center gap-4">
        ...
        {isLoading ? (
          ...
          <div className="flex min-h-[250px] w-full flex-col items-center justify-center py-8">
            ...
            <p className="text-muted-foreground mt-2 max-w-[280px] text-center text-xs whitespace-normal">
              No se encontraron datos de transporte para el rango de fechas seleccionado. Ajusta las
              fechas para ver los datos.
            </p>
          </div>
        )}
      </CardContent>
