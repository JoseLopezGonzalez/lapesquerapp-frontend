...
export default function QRConfigPanel({ value, onChange, fieldOptions }) {
  ...
  return (
    <div className="space-y-2">
      <Button variant="outline" size="sm" onClick={() => setIsDialogOpen(true)} className="w-full">
        ...
        <DialogContent size="5xl" className="flex max-h-[90vh] flex-col">
          ...
          <div className="flex-1 overflow-auto">
            <div className="space-y-4">
              ...
              <div
                ref={setEditorRef}
                className="border-input bg-background relative min-h-[300px] rounded-md border p-4 text-base break-words whitespace-pre-wrap focus-within:outline-none"
