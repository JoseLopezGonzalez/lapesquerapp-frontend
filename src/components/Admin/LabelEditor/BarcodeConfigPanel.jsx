    ...
    <div className="space-y-2">
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2 pt-2">
          ...
          <Label htmlFor="show-value" className="text-xs">
            Mostrar caracteres
          </Label>
        </div>
      </div>
      ...
      <div className="flex justify-center rounded border p-2">
        {isValidBarcode() ? (
          ...
          <span className="text-sm text-red-500">Valor no válido para {type.toUpperCase()}</span>
        )}
      </div>
        ...
        <DialogContent size="5xl" className="flex max-h-[90vh] flex-col">
          ...
          <div className="flex-1 overflow-auto">
            <div className="space-y-4">
              ...
              <div
                ref={setEditorRef}
                className="border-input bg-background min-h-[300px] rounded-md border p-4 text-base focus-within:outline-none"
