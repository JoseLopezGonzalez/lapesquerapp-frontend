...
const ListadoComprasLonjaDeIsla = ({ document, hideExport = false, onDocumentCorrection }) => {
  ...
  return (
    <div className="py-8">
      <div className="container mx-auto space-y-3 rounded-md bg-white py-3 text-black shadow-md">
        <img src="/images/logos/logo-lonja-isla.png" alt="Logo" className="mx-auto mb-4 h-32" />

        <div className="container mx-auto max-w-5xl p-6">
          <div className="grid gap-6 md:grid-cols-2">
            {/* Sección de Datos del Albarán */}
            <Card className="col-span-2 border-neutral-200 bg-white text-black">
              <CardHeader className="pb-0">
                <CardTitle className="text-base">Listado de Compras</CardTitle>
              </CardHeader>
              <CardContent className="w-full px-10 py-5">
      ...
      {!hideExport && (
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <div className="fixed right-9 bottom-8">
