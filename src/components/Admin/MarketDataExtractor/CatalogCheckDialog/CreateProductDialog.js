        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-2">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-1.5">
              ...
              />
              {errors.speciesId && (
                <p className="text-xs text-red-400">* {errors.speciesId.message}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              {errors.captureZoneId && (
                <p className="text-xs text-red-400">* {errors.captureZoneId.message}</p>
              )}
            </div>
            ...
            <div className="space-y-1.5">
              ...
              />
              {errors.familyId && (
                <p className="text-xs text-red-400">* {errors.familyId.message}</p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <Label htmlFor="cp-a3erp">
              Código A3ERP <span className="text-muted-foreground font-normal">(opcional)</span>
            </Label>
            <Input
              id="cp-a3erp"
              {...register('a3erpCode')}
