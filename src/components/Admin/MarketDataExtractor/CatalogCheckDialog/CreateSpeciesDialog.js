        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 py-2">
          <div className="grid grid-cols-4 gap-4">
            <div className="col-span-1 space-y-1.5">
              ...
              <Input
                ...
                className="uppercase"
              />
              {errors.fao && <p className="text-xs text-red-400">* {errors.fao.message}</p>}
            </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.scientificName && (
              <p className="text-xs text-red-400">* {errors.scientificName.message}</p>
            )}
          </div>
          ...
          <div className="space-y-1.5">
            ...
            {errors.fishingGearId && (
              <p className="text-xs text-red-400">* {errors.fishingGearId.message}</p>
            )}
          </div>
