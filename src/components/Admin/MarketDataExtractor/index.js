...
import { BookOpenIcon, BookOpenText, Download, FileX2, Link2, Package, Sparkles, TextSearch } from "lucide-react";
...
export default function MarketDataExtractor() {
    ...
    const processAlbaranCofradiaPescadoresSantoCristoDelMar = () => {
        ...
        extractDataWithAzureDocumentAi({
            ...
            console.error(error);
            toast.error("Error al procesar el documento.", getToastTheme());
        }).finally(() => {
            setLoading(false);
        });
