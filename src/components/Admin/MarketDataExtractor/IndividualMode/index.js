...
export default function IndividualMode() {
  ...
  return (
    <div className="bg-background flex h-full gap-4">
      {/* Panel de control (30%) */}
      <Card className="flex w-full flex-col gap-6 border-r p-6 md:w-[30%]">
        ...
        <div className="flex h-full w-full justify-center overflow-y-auto">
          {loading ? (
            ...
            <div className="flex flex-1 items-center justify-center">
              <EmptyState
                icon={<TextSearch className="text-primary h-12 w-12" strokeWidth={1.5} />}
