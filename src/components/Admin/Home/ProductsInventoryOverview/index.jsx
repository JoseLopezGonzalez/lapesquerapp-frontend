...
const ProductsInventoryOverview = () => {
    ...
    useEffect(() => {
        if (productName === '') {
            totalProductsInventory?.productsInventory?.length > 0 && setFilteredProductsInventory(totalProductsInventory.productsInventory)
        } else {
        ...
        <>
            ...
            <div className='bg-gradient-to-br from-neutral-500/50 via-neutral-700/50 to-sky-500 p-[1px] rounded-2xl'>
                <div className="p-4 md:p-5  flex flex-col  shadow-sm rounded-2xl bg-gradient-to-br from-neutral-900 via-neutral-800 to-sky-900 ">
                    ...
                    {/* <!-- End Header --> */}
                    <div className='flex items-center justify-center w-full px-1 sm:px-5 '>
