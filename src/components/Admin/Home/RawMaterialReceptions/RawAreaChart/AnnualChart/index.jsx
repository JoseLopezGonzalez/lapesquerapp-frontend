...
const AnnualChart = ({ species, setDataFilterUi, setNetWeight, setPercentageChange }) => {
    ...
    useEffect(() => {
        ...
        setDataFilterUi(
            <select
                className="min-w-20  border text-xs rounded-lg block w-full p-1.5 px-2 bg-neutral-900 border-neutral-600 placeholder-neutral-100 text-white focus:ring-sky-500 "
                id="year"
                name="year"
        ...
        getRawMaterialReceptionAnnualStats(year, species)
            .then(data => {
                setStats(data);
    ...
    return (
        <>
            {loading ? (
                <div className="animate-pulse flex items-center justify-center p-0 sm:p-4 pt-10 h-[180px]">
                    {/* Loader */}
                ...
                <div className='flex items-center justify-center pr-4 pt-10'>
                    <ResponsiveContainer width="100%" height={140}>
                        <AreaChart data={stats?.monthlyNetWeights}>
                            ...
                            <Area type="monotone" dataKey="currentYear" stroke="rgb(14 165 233)" strokeWidth={2.5} fillOpacity={1} fill="url(#colorCurrentYear)" />
                        </AreaChart>
                    </ResponsiveContainer>
                </div>
            ) : (
                <div className="w-full flex flex-col items-center justify-center h-[175px]">
                    <div className='flex flex-col items-center justify-center gap-1'>
                        ...
                        <div className='flex flex-col items-center justify-center'>
                            ...
                            <p className='text-xs text-neutral-100/85 font-light'>Prueba a filtrar por otros años.</p>
