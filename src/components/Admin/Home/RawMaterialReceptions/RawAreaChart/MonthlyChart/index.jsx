...
const MonthlyChart = ({ species, setDataFilterUi, setNetWeight, setPercentageChange }) => {
  ...
  useEffect(() => {
    ...
    setDataFilterUi(
      <input
        ...
        value={month}
        type="month"
        className="block w-full rounded-lg border border-neutral-600 bg-neutral-900 p-1.5 px-2 text-xs text-white placeholder-neutral-100 focus:ring-sky-500"
      />
    );
    getRawMaterialReceptionMonthlyStats(month, species).then((data) => {
      setStats(data);
  ...
  return (
    <>
      {loading ? (
        <div className="flex h-[140px] animate-pulse items-center justify-center p-0 pt-10 sm:p-4">
          ...
          <div className="flex flex-col items-center justify-center gap-1">
            ...
            <div className="flex flex-col items-center justify-center">
              ...
              <p className="text-xs font-light text-neutral-100/85">
                Prueba a filtrar por otros meses.
              </p>
            </div>
          </div>
        </div>
