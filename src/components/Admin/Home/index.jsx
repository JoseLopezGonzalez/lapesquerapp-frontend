  ...
  return (
    <>
      <div
        className={cn(
          'h-full w-full overflow-y-auto',
          'flex flex-col gap-4 md:grid md:grid-cols-10 md:gap-5', // Stack vertical en mobile, grid en desktop
          'px-4 md:px-6 xl:px-20', // Padding responsive
          'pt-4 pb-10 md:pt-14' // Padding top reducido en mobile
        )}
      >
        {/* Title */}
        <div className="mb-2 w-full md:col-span-10 md:mb-5">
          <h1 className="text-2xl font-thin text-neutral-300 md:text-3xl">Panel de Control</h1>
        </div>
