  ...
  if (validPallets.length === 0) {
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        >
          <DialogHeader>
            <DialogTitle>Imprimir Todas las Etiquetas</DialogTitle>
          </DialogHeader>
  ...
  return (
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        ...
        >
          <DialogHeader>
            <DialogTitle>Imprimir Todas las Etiquetas ({validPallets.length} pallets)</DialogTitle>
          </DialogHeader>
          <div className="flex w-full flex-1 flex-col justify-center">
            <Alert variant="destructive" className="mb-4 w-full max-w-md">
              ...
              <AlertDescription className="text-sm">
                Productos o lotes podrían no mostrarse completamente. Cada etiqueta se imprimirá en
                una página separada.
              </AlertDescription>
            </Alert>
