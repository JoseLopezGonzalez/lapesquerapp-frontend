...
/* TabsList: look doc shadcn — bg-muted p-1 text-muted-foreground rounded-lg */
...
/* TabsTrigger: activo con bg-background, text-foreground y shadow-sm para el “pop” de la doc */
