        ...
        <div className="flex-1 overflow-y-auto px-4 pb-4">
          <div className="space-y-3 rounded-2xl border bg-card p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Tienes acceso a {user?.allowedStoreIds?.length || 0} almacenes
                  asignados y a sus movimientos permitidos.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Mantiene el mismo sistema visual y tokens que el resto de la
                  aplicacion.
                </p>
              </div>
              <ThemeToggle />
          ...
          <div className="pt-4">
            <button
              ...
              className={cn(
                "flex min-h-[56px] w-full items-center gap-3 rounded-xl border-2 border-destructive/20 bg-destructive/5 px-4 py-3 text-left text-base font-medium text-destructive",
                "transition-all duration-150 hover:bg-destructive/10 hover:border-destructive/30"
              )}
            >
