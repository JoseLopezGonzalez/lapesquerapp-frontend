...
export function calculateRecordTotals(inputs, consumptions, outputs) {
  const totalInputWeight =
    calculateTotalInputWeight(inputs) + calculateTotalConsumptionWeight(consumptions);
  const totalInputBoxes =
    calculateTotalInputBoxes(inputs) + calculateTotalConsumptionBoxes(consumptions);
 ...
 */
export function updateRecordWithCalculatedTotals(
  record,
  inputs = null,
  consumptions = null,
  outputs = null
