...
import {
  processDocument,
  getAzureDocumentType,
  isValidDocumentType,
  getAvailableDocumentTypes,
} from '@/components/Admin/MarketDataExtractor/shared/DocumentProcessor';
...
describe('DocumentProcessor', () => {
  describe('getAzureDocumentType', () => {
    it('returns correct Azure type for albaranCofradia', () => {
      expect(getAzureDocumentType('albaranCofradiaPescadoresSantoCristoDelMar')).toBe(
    ...
    it('returns correct Azure type for asoc', () => {
      expect(getAzureDocumentType('listadoComprasAsocArmadoresPuntaDelMoral')).toBe(
  ...
  describe('processDocument', () => {
    ...
    it('throws for invalid document type', async () => {
      await expect(processDocument(mockFile, 'invalidType')).rejects.toThrow(
