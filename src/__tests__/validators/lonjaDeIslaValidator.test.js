...
describe('validateLonjaDeIslaStructure', () => {
  const validDocument = {
    ...
    tables: {
      ...
      peces: [{ fao: 'TU', descripcion: 'Atún', kilos: '100', importe: '550' }],
      vendidurias: [{ vendiduria: 'Vend 1', cajas: '10', kilos: '100', importe: '550' }],
      cajas: [{ descripcion: 'Caja 5kg', cajas: '20', importe: '100' }],
      tipoVentas: [{ descripcion: 'Subasta', cajas: '10', importe: '550' }],
    },
  };
