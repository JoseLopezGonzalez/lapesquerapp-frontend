# Documentación del Chat AI - La PesquerApp

Este directorio contiene toda la documentación relacionada con el sistema de Chat AI integrado en La PesquerApp.
...
**👉 Úsalo para entender rápidamente la estructura del chat.**
...
**👉 Úsalo para entender todos los detalles técnicos de la implementación.**
...
**👉 Úsalo para entender cómo se planificó la integración.**
...
**👉 Úsalo para un resumen rápido del estado del proyecto.**
...
- Esta documentación corresponde a la versión **AI SDK v6** con **OpenAI GPT-5**
- El sistema está integrado con la arquitectura de servicios de dominio
- Todas las tools acceden a datos reales del ERP mediante services autenticados
