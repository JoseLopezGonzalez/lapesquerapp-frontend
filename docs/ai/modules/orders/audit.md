...
6 ready, 9 done, 0 blocked y 1 rejected por merge.
...
P0 abiertos: 0   P1 abiertos: 2 (GAP-V2-001, 006)
P2 abiertos: 2   P3 abiertos: 2

Estado de auditoría:      audited_acotado (5 de 5 carriles previstos ejecutados)
Estado de implementación: batch_7_done (GAP-V2-002, GAP-V2-004, GAP-V2-021, GAP-V2-011, GAP-V2-012, GAP-V2-013, GAP-V2-020, GAP-V2-003, GAP-V2-005)
Estado de verificación:   GAP-V2-003/GAP-V2-005 audited_done
```
...
Ver `docs/ai/modules/orders/gaps-registry.md` (regenerado). Resumen: 6 `ready`, 9 `done`, 0 `blocked`, 0 `later`, 1 `rejected`.
