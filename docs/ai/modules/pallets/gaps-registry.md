...
| GAP-V2-082 | Tara por caja solo disponible en el modo de alta "promedio" — alta manual, masiva y por lector no permiten descontarla | domain-business | P3 | low | M | GAP-V2-079 | src/hooks/pallets/usePalletBoxCreation.ts<br>src/components/Admin/Pallets/PalletDialog/PalletView/index.tsx<br>src/components/Admin/Pallets/PalletDialog/MobilePalletView/AddManualScreen.tsx | 2026-07-05 |
