...
- **Tareas complejas o multi-paso**: Di algo como _“Aplica el protocolo de .ai_standards/AGENT_MEMORY_SYSTEM.md”_ o referencia `@.ai_standards/AGENT_MEMORY_SYSTEM.md`.
