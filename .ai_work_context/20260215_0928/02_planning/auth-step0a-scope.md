...
| **fetchWithTenant**  | `src/lib/fetchWithTenant.js`        | Inyecta X-Tenant (desde host o headers), manejo 401/403 y coordinación con **is_logging_out**.                       |
...
| **useIsLoggingOut**   | `src/hooks/useIsLoggingOut.js`        | Lee sessionStorage **is_logging_out**; usado por AdminRouteProtection.                |
...
Responder por ejemplo: _"Confirmado"_ o _"Añadir X"_ / _"Quitar Y"_.
