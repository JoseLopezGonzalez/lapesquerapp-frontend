...
- **Azure**: Llamada a Document AI, polling. Usa fetchWithTenant. API key en NEXT*PUBLIC*\* (auditoría ya flaggea riesgo).
...
3. **Azure API key en NEXT*PUBLIC*\***: Riesgo de seguridad (ya documentado en auditoría global).
